...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-liberty-base">
      ...
      {/* Hero Section */}
      <section className="py-20 bg-liberty-base">
      ...
      {/* Contact Form */}
      <section id="contact-form" className="py-20 bg-liberty-base">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Card className="bg-liberty-surface-muted border-liberty-primary/20">
